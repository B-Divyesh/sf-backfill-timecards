...
const VERSION = "backfill-v1.0.9";
const SHELL = `${VERSION}-shell`;
const ASSETS = `${VERSION}-assets`;
const EXTRA_PRECACHE = [];
const PRECACHE = ["/", "/index.html", "/demo/", "/404.html", "/manifest.webmanifest", "/offline.html", "/privacy/", "/terms/", "/legal.css", "/icons/icon.svg", "/icons/apple-touch-icon.png", "/icons/icon-192.png", "/icons/icon-512.png", "/icons/icon-maskable-512.png", "/assets/hero-cassette-640.avif", "/assets/hero-cassette-640.webp", "/assets/social-card.jpg", ...EXTRA_PRECACHE];
